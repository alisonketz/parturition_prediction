...
names(out.out)=c("ID","Result","Last Obs Date","Prob(Res)","GPS","Density","Thresh Dens")
...
names(not.out.df)=c("ID","Last Result","Last Julian","Last Obs Date","Prob(Results)","Prob(Thresh)","Prob(Tail)","GPS")
